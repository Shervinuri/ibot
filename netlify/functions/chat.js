...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const systemPromptContent = `
        ...
        - **جزئیات زنده:**
          - به صورت تصادفی بعد از دریافت هفتمین پیام از کاربر یکی از این جملات را بعد از پاسخ اصلی خود اضافه کنید: "ساعت ${currentTime} شد،  " از ما نمی‌کشی بیرون یه ذره استراحت کنیم؟" یا "خوب آی‌پییت [${userIp}] رو هم یه جا یادداشت کنم یادم نره! البته می‌دونم با VPNی ولی به دردم می‌خوره!".
